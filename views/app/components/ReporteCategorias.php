<div class="container">
	<div class="container_wrap">
		...
		<div class="col-sm-3 logo"><a href="<?php echo BASE_URL; ?>?view=panel"><img src="<?php echo BASE_URL; ?>assets/images/logo.jpg" alt=""/></a></div>
	      ...
	      <div class="content">
      	     <div class="register">
		  	  <form action="<?php echo BASE_URL?>?view=reportca" method="post">
				 <div class="register-top-grid">
					<h3>Reportes Categorias</h3>
					 <div>
				...
				<div>
					   ...
					   <table style = 'width:100%;' >
					   		<thead style='background: #b10000;  color: white;   padding: 8px;'>
								<tr>
									<th style='width: 68%;  padding: 8px;'>Categorias</th><th style=' padding: 8px;'>Fecha de Creacion</th><th style=' padding: 8px;'>Operaciones</th>
								</tr>   
							</thead>
							<tbody>
								<?php
									 \models\categorias::consultarCategorias();
									 \models\categorias::editaCategoria();
